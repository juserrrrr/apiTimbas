...
export class StreamingEventsController {
  constructor(private readonly streaming: StreamingService) {}

  // EventSource cannot send an Authorization header. The single-use ticket
  // authenticates this route and is minted by the protected controller.
