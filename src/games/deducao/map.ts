...
export type TaskDuration = 'curta' | 'media' | 'longa';
...
const TASK_SPOTS: TaskSpot[] = [
  ...
  },
  {
    ...
    kind: 'impressora',
    room: 'openspace',
    label: 'Destravar a fila de impressão',
    x: 49,
    z: 15 - 1.05 / OFFICE_LAYOUT_SCALE,
  },
  {
    id: 'cabos-reuniao',
    kind: 'cabos',
    room: 'reuniao',
    label: 'Reconectar a tela de apresentação',
    x: 61,
    z: 5.5,
  },
  {
    ...
    kind: 'arquivo',
    room: 'reuniao',
    label: 'Organizar as atas da reunião',
    x: 53.5,
    z: 8,
  },
  {
    ...
    kind: 'senha',
    room: 'reuniao',
    label: 'Liberar a videoconferência',
    x: 68.6,
    z: 12.5,
  },
  {
    ...
    kind: 'arquivo',
    room: 'recepcao',
    label: 'Conferir os registros de visitantes',
    x: 5.3,
    z: 25,
  },
  {
    ...
    kind: 'cabos',
    room: 'recepcao',
    label: 'Reconectar o painel de recepção',
    x: 16.8,
    z: 22,
  },
  {
    ...
    kind: 'cabos',
    room: 'corredor-oeste',
    label: 'Restabelecer o circuito oeste',
    x: 21,
    z: 20,
  },
  {
    ...
    kind: 'arquivo',
    room: 'corredor-oeste',
    label: 'Atualizar o quadro de avisos',
    x: 25,
    z: 37,
  },
  {
    ...
    kind: 'cabos',
    room: 'hall-central',
    label: 'Ajustar a iluminação do átrio',
    x: 29.5,
    z: 25.5,
  },
  {
    ...
    kind: 'senha',
    room: 'hall-central',
    label: 'Validar o controle de acesso',
    x: 30,
    z: 37,
  },
  {
    ...
    kind: 'cabos',
    room: 'corredor-leste',
    label: 'Revisar o circuito leste',
    x: 49,
    z: 20,
  },
  {
    ...
    kind: 'senha',
    room: 'corredor-leste',
    label: 'Desbloquear o painel de segurança',
    x: 53,
    z: 37,
  },
  {
    id: 'estoque-servico',
    kind: 'estoque',
    room: 'corredor-servico',
    label: 'Conferir os materiais de manutenção',
    x: 49,
    z: 44,
  },
  {
    ...
    kind: 'cabos',
    room: 'corredor-servico',
    label: 'Religar a alimentação de serviço',
    x: 53,
    z: 52,
  },
  {
    ...
    kind: 'cabos',
    room: 'copa',
    label: 'Reconectar a ventilação da copa',
    x: 57.2,
    z: 20,
  },
  {
    ...
    kind: 'arquivo',
    room: 'apoio',
    label: 'Separar os formulários de suporte',
    x: 7,
    z: 36.2 + 1 / OFFICE_LAYOUT_SCALE,
  },
  {
    id: 'estoque-apoio',
    kind: 'estoque',
    room: 'apoio',
    label: 'Montar os kits de escritório',
    x: 12,
    z: 36.2 + 1 / OFFICE_LAYOUT_SCALE,
  },
  {
    ...
    kind: 'senha',
    room: 'apoio',
    label: 'Reabrir o terminal de suporte',
    x: 8 + 1.4 / OFFICE_LAYOUT_SCALE,
    z: 45,
  },
  {
    id: 'cabos-banheiro',
    kind: 'cabos',
    room: 'banheiro',
    label: 'Revisar o painel de ventilação',
    x: 58.5,
    z: 37.2,
  },
  {
    ...
    kind: 'arquivo',
    room: 'deposito',
    label: 'Classificar as etiquetas de entrega',
    x: 58 + 1.1 / OFFICE_LAYOUT_SCALE,
    z: 50,
  },
  {
    id: 'cabos-deposito',
    kind: 'cabos',
    room: 'deposito',
    label: 'Reconectar o leitor de estoque',
    x: 68,
    z: 47,
  },
  {
    ...
    kind: 'senha',
    room: 'arquivo',
    label: 'Desbloquear o arquivo protegido',
    x: 21 - 1.1 / OFFICE_LAYOUT_SCALE,
    z: 10,
    level: 1,
  },
  {
    ...
    kind: 'cabos',
    room: 'operacoes',
    label: 'Restabelecer a estação de monitoramento',
    x: 33.2 + 1.05 / OFFICE_LAYOUT_SCALE,
    z: 6 + 1.1 / OFFICE_LAYOUT_SCALE,
    level: 1,
  },
  {
    ...
    kind: 'rack',
    room: 'operacoes',
    label: 'Sincronizar o backup operacional',
    x: 45.6 + 1.05 / OFFICE_LAYOUT_SCALE,
    z: 6 + 1.1 / OFFICE_LAYOUT_SCALE,
    level: 1,
  },
  {
    ...
    kind: 'arquivo',
    room: 'chefe',
    label: 'Revisar os contratos da diretoria',
    x: 69.1 - 1.1 / OFFICE_LAYOUT_SCALE,
    z: 9.5,
    level: 1,
  },
  {
    ...
    kind: 'cabos',
    room: 'chefe',
    label: 'Reconectar a tela da diretoria',
    x: 61,
    z: 5.8,
    level: 1,
  },
  {
    ...
    kind: 'estoque',
    room: 'lounge',
    label: 'Reabastecer os lanches do lounge',
    x: 17 - 1.218 / OFFICE_LAYOUT_SCALE,
    z: 20,
    level: 1,
  },
  {
    ...
    kind: 'senha',
    room: 'lounge',
    label: 'Reiniciar o fliperama',
    x: 17.2 - 1.05 / OFFICE_LAYOUT_SCALE,
    z: 28.8,
    level: 1,
  },
  {
    ...
    kind: 'cabos',
    room: 'lounge',
    label: 'Conectar a mesa de jogos',
    x: 11,
    z: 20.8 + 1.1 / OFFICE_LAYOUT_SCALE,
    level: 1,
  },
  {
    id: 'arquivo-superior-oeste',
    kind: 'arquivo',
    room: 'corredor-superior-oeste',
    label: 'Organizar os comunicados internos',
    x: 21,
    z: 20,
    level: 1,
  },
  {
    id: 'cabos-superior-oeste',
    kind: 'cabos',
    room: 'corredor-superior-oeste',
    label: 'Revisar a rede do corredor oeste',
    x: 25,
    z: 38,
    level: 1,
  },
  {
    ...
    kind: 'cabos',
    room: 'hall-superior',
    label: 'Ajustar as luzes do mezanino',
    x: 35,
    z: 20.2,
    level: 1,
  },
  {
    ...
    kind: 'senha',
    room: 'hall-superior',
    label: 'Validar o painel do mezanino',
    x: 29.5,
    z: 32,
    level: 1,
  },
  {
    id: 'senha-superior-leste',
    kind: 'senha',
    room: 'corredor-superior-leste',
    label: 'Validar a ronda de segurança',
    x: 49,
    z: 20,
    level: 1,
  },
  {
    id: 'cabos-superior-leste',
    kind: 'cabos',
    room: 'corredor-superior-leste',
    label: 'Revisar a rede do corredor leste',
    x: 53,
    z: 38,
    level: 1,
  },
  {
    ...
    kind: 'cabos',
    room: 'terraco',
    label: 'Restabelecer as luzes do pergolado',
    x: 58.5,
    z: 24,
    level: 1,
  },
  {
    ...
    kind: 'estoque',
    room: 'terraco',
    label: 'Separar o kit de jardinagem',
    x: 66.5,
    z: 46 - 1.5 / OFFICE_LAYOUT_SCALE,
    level: 1,
  },
  {
    id: 'senha-terraco',
    kind: 'senha',
    room: 'terraco',
    label: 'Reiniciar o controle de irrigação',
    x: 67,
    z: 51,
    level: 1,
  },
  {
    ...
    kind: 'arquivo',
    room: 'conselho',
    label: 'Organizar a pauta do conselho',
    x: 5.2,
    z: 38,
    level: 1,
  },
  {
    ...
    kind: 'senha',
    room: 'conselho',
    label: 'Autorizar a votação do conselho',
    x: 16.7,
    z: 47,
    level: 1,
  },
...
const taskRoomCount = new Map<string, number>();
const TASK_SPOTS_BUILT = TASK_SPOTS.map((spot) => {
  const index = taskRoomCount.get(spot.room) ?? 0;
  taskRoomCount.set(spot.room, index + 1);
  return {
    ...compactPlacement(spot),
    duration: (['curta', 'media', 'longa'] as const)[index % 3],
  };
});
