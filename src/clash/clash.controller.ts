...
export class ClashController {
  ...
  async retryAiAnalysis(@Body() body: { players?: FullPlayerData[]; teamProfile?: TeamTacticalProfile }) {
    ...
    return this.clashService.retryAiAnalysis(body.players, body.teamProfile);
  }
